...
v1.24 Aug 7th - merge penny's works. fix weird bugs happend during integration:<br>
<li>fix codec issue in room description</li> 
<li>fix readRoomFile() reading hidden system file on different OS</li>
<li>fix json format, naming difference for room files</li>
<li>revise game.py from crashing when accessing hidden attribute of room file</li>